...
const About =() =>{
    return (
        ...
        <div className='about ' style={{backgroundColor:'#424242'}}>
             <Carousel className='w-4/5 border m-auto mt-20' effect="fade" autoplay="true">
                <div style={contentStyle}>
                <img className='w-full h-full' src="https://cdn.cloudflare.steamstatic.com/steam/apps/671860/capsule_231x87.jpg?t=1686877598" ></img>
                </div>
    <div style={contentStyle}>
    <img className='w-full h-full' src="https://cdn.cloudflare.steamstatic.com/steam/apps/1172470/capsule_231x87.jpg?t=1685123076" ></img>
    </div>
    <div style={contentStyle}>
    <img className='w-full h-full' src="https://cdn.cloudflare.steamstatic.com/steam/apps/578080/capsule_231x87.jpg?t=1684838697" ></img>
    </div>
    <div style={contentStyle}>
    <img className='w-full h-full' src="https://cdn.cloudflare.steamstatic.com/steam/apps/1364780/capsule_231x87.jpg?t=1686291121" ></img>
    </div>
    <div style={contentStyle}>
    <img  className='w-full h-full' src="https://cdn.cloudflare.steamstatic.com/steam/apps/916440/capsule_231x87.jpg?t=1681854014"></img>
    </div>
    <div style={contentStyle}>
    <img className='w-full h-full' src="https://cdn.cloudflare.steamstatic.com/steam/apps/1942280/capsule_231x87.jpg?t=1687514377" ></img>
    </div>
    <div style={contentStyle}>
    <img className='w-full h-full' src="https://cdn.cloudflare.steamstatic.com/steam/apps/281990/capsule_231x87.jpg?t=1687453160" ></img>

    </div>
    <div  style={contentStyle}>
    <img  className='w-full h-full' src="https://cdn.cloudflare.steamstatic.com/steam/apps/1548850/capsule_231x87.jpg?t=1687576255" ></img>
...
<div className='photo flex items-center justify-center mt-20 mb-20'>
        <div className="about_cta_community rounded-lg	border-x-orange-300	border-solid border w-9/12">
                    <div className="cta_content pt-8">
                            <h2 className="cta_title font-extrabold text-3xl text-sky-300	 normal-case tracking-normal text-center mb-10 font-mono">Join Our Community</h2>
                        ...
                        <div className="cta_hero relative flex flex-row items-center ">
                            ...
                            <div className="cta_text  text-3xl text-white ml-2.5 font-serif	" style={{color:'#C6C6C6'}}>
